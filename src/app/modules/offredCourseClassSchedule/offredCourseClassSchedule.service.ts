...
import { IOfferedCourseClassScheduleFilterRequest } from './offeredCourseCalssSchedule.interface';
import {
  offeredCourseClassScheduleRelationalFields,
  offeredCourseClassScheduleRelationalFieldsMapper,
  offeredCourseClassScheduleSearchabalfields,
...
const insertIntoDB = async (
  ...
  // existingSlots 12:00 - 13:00
  // new Slot 12:30 - 13:00
...
const getAllFromDB = async (
  ...
  if (searchTerm) {
    andCondition.push({
      OR: offeredCourseClassScheduleSearchabalfields.map(field => ({
        [field]: {
          contains: searchTerm,
          mode: 'insensitive',
        },
