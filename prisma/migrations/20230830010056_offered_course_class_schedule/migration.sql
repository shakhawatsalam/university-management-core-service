...
CREATE TABLE "offered_course_class_schedules" (
    ...
    "offredCourseSectionId" TEXT NOT NULL,
...
-- AddForeignKey
ALTER TABLE "offered_course_class_schedules" ADD CONSTRAINT "offered_course_class_schedules_offredCourseSectionId_fkey" FOREIGN KEY ("offredCourseSectionId") REFERENCES "offred_course_sections"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
